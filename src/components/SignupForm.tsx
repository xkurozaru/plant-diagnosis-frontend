...
const SignupForm = () => {
    ...
    return (
        <Box maxW="fit-content" px="6" py="4">
            <Heading as="h2" size="lg">サインアップ</Heading>
            ...
            <FormControl isInvalid={isErrorName} mt="5">
                ...
                <FormErrorMessage>ユーザー名は2文字以上32文字以下で入力してください</FormErrorMessage>
            </FormControl>
            <FormControl isInvalid={isErrorPassword} mt="2">
                ...
                <FormErrorMessage>パスワードは8文字以上72文字以下で入力してください</FormErrorMessage>
            </FormControl>
            <Button mt="5" onClick={handleSignup} isDisabled={isErrorName || isErrorPassword}>サインアップ</Button>
        </Box>
    )
}
